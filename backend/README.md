...
## Project Structure
    ...
    ├── testtemplate_dev_37887  # Django project configurations
...
1. Clone this repo and `cd testtemplate_dev_37887`
...
2. Clone this repo and `cd testtemplate_dev_37887`
